      ...
      <DialogContent>
        <Box sx={{ mb: 2 }}>
          <Typography variant="body1" gutterBottom sx={{ textTransform: 'lowercase' }}>
            <b>ai hackathon gallery</b> is a collection of simple, modern web games and playful apps, built in 12 hours as a single react + typescript codebase. each mini-app is standalone, mobile-friendly, and shares a unified theme system. the project demonstrates rapid prototyping, code organization, and ui consistency using material ui.
          </Typography>
